...
<img
  ...
  style="width: 100%; border-radius: 0.5rem; margin: 2rem 0;"
/>
...
<CardGrid>
  <Card title="Läuft offline – wirklich" icon="laptop">
    ...
    `.fwincident`-Datei, die dir gehört und die du archivieren, kopieren oder
    weitergeben kannst.
  </Card>
  <Card title="Keine Daten verlassen den ELW" icon="approve-check">
    Stammdaten, Namen und Handynummern liegen nur auf deinem Gerät. Die
...
| **Aufgaben** | Aufträge mit Wichtigkeit, Dringlichkeit, Zuständigem und Timer – mit Sprachansage, wenn sie fällig werden |
...
| **CO-Messprotokoll** | Haus, Stockwerk, Wohnung: Status, ppm-Wert mit Gefahrenfarbe, Bewohnername, Schlüssel vorhanden – wie die Türmarkierung vor Ort |
